    ...
    <PublicLayout>
      <section className="max-w-3xl mx-auto py-16 px-4 animate-fade-up">
        <div className="mb-10 text-center">
          <h1 className="text-4xl font-extrabold text-[#00B074] mb-2">Contactez l’équipe Famease</h1>
            ...
            <div className="bg-[#f0fef8] rounded-lg p-4 mt-4 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Pour une assistance technique rapide, écrivez à <a href="mailto:support@famease.fr" className="text-[#00B074] underline">support@famease.fr</a>
                </div>
              </div>
            </div>
          </div>
